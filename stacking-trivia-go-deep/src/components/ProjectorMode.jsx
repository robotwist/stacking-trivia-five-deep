...
export default function ProjectorMode({ 
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center p-16">
        ...
        {gameState === 'question' && question && (
          ...
          >
            ...
            >
              <div className="inline-block bg-yellow-400 text-black px-6 py-3 rounded-full text-2xl font-bold">
            ...
            {/* Decorative divider */}
            <motion.div 
              className="w-64 h-1 bg-gradient-to-r from-transparent via-yellow-400 to-transparent mx-auto mb-8"
              initial={{ width: 0 }}
              animate={{ width: 256 }}
        ...
        {gameState === 'scoreboard' && (
          <motion.div 
            ...
            transition={{ duration: 1, ease: "backOut" }}
          >
            <h2 className="text-6xl font-bold mb-12 text-yellow-400">Current Standings</h2>
            ...
            <div className="space-y-6">
              {teams
                ...
                <motion.div
                  key={team.id}
                  className="flex justify-between items-center bg-black bg-opacity-50 p-6 rounded-lg border-2 border-yellow-400"
                  initial={{ x: -100, opacity: 0 }}
                  animate={{ x: 0, opacity: 1 }}
                  transition={{ delay: index * 0.2, duration: 0.8 }}
                >
                  <div className="flex items-center">
                    <div className="text-4xl font-bold text-yellow-400 w-16">
                      #{index + 1}
                    </div>
        ...
        {gameState === 'performance' && (
          ...
          >
            ...
            <p className="text-4xl text-yellow-200 mb-12">
      ...
      <motion.button
        onClick={onClose}
        className="absolute top-8 right-8 text-2xl bg-black bg-opacity-70 text-white px-6 py-3 rounded-lg hover:bg-opacity-90 transition-all z-20"
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
