    ...
    return (
      <div className="min-h-screen transition-colors duration-300 bg-gradient-to-br from-amber-50 via-yellow-100 to-amber-100 text-amber-900" style={{ fontFamily: 'Baskerville, serif' }}>
        <div className="container mx-auto px-4 py-8 text-center">
          ...
          {/* Dramatic Intro */}
          <div className="mb-12">
            <h1 className="text-5xl sm:text-7xl font-bold mb-6 text-amber-800 drop-shadow-lg">
              Round 1
            </h1>
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              "And Now for Something Completely Deep"
            </h2>
            <p className="text-lg sm:text-xl mb-8 text-amber-700 max-w-3xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 max-w-4xl mx-auto">
              {teams.map((team, index) => (
                <div
                  key={team.id}
                  className="p-4 bg-amber-100/80 border border-amber-300 shadow-lg rounded-sm"
                >
          ...
          <div className="max-w-2xl mx-auto mb-8 p-6 bg-amber-100/50 border border-amber-200 rounded-sm">
            <h3 className="text-xl font-bold mb-4">Visual Prompt Ready</h3>
            <div className="w-32 h-32 mx-auto bg-gradient-to-br from-amber-500 to-yellow-600 rounded-sm flex items-center justify-center mb-4">
          ...
          <button
            ...
            className="bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-700 hover:to-yellow-700 text-white px-12 py-6 rounded-sm text-2xl font-bold transition-all duration-300 transform hover:scale-105 shadow-xl sepia filter"
          >
    ...
    <div className="min-h-screen transition-colors duration-300 bg-gradient-to-br from-amber-50 via-yellow-100 to-amber-100 text-amber-900" style={{ fontFamily: 'Baskerville, serif' }}>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4 text-amber-800 drop-shadow-lg">
            Opening Image Round
          </h1>
        ...
        <div className="max-w-4xl mx-auto mb-8">
          <div className="p-8 bg-amber-100/70 backdrop-blur-sm shadow-lg border border-amber-300 rounded-sm mb-6">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold mb-4">Your Visual Prompt:</h2>
              <div className="relative max-w-md mx-auto rounded-sm overflow-hidden shadow-2xl sepia filter">
                <img 
        ...
        <div className="max-w-4xl mx-auto">
          <div className="p-6 bg-amber-100/90 backdrop-blur-sm shadow-xl border border-amber-300 rounded-sm">
            <div className="text-center mb-6">
            ...
            <div className="text-center">
              ...
              <button
                ...
                className="bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-700 hover:to-yellow-700 text-white px-8 py-4 rounded-sm text-lg font-semibold transition-all duration-300 sepia filter"
              >
